...
public class TransactionRestControllerV1Test{
    ...
    private final String AUTH_HEADER = "Basic " + Base64.getEncoder().encodeToString("00000:00000".getBytes());
    ...
    void getAllTransactionsShouldReturnListOfTransactionDto() {
        ...
        webTestClient.get().uri(url + "/transaction/list")
                ...
                .jsonPath("$[0].card_data.card_number").isEqualTo("4102778822334893")
                .jsonPath("$[0].card_data.exp_date").isEqualTo("11/23")
                .jsonPath("$[0].card_data.cvv").isEqualTo("566")
    ...
    void getTransactionByIdShouldReturnTransactionDto() {
        ...
        webTestClient.get().uri(url + "/transaction/" + transactionId.get("id") + "/details")
                ...
                .jsonPath("$.card_data.card_number").isEqualTo("4102778822334893")
                .jsonPath("$.card_data.exp_date").isEqualTo("11/23")
                .jsonPath("$.card_data.cvv").isEqualTo("566")
